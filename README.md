...
You can find the standalone `.exe` version in the [Releases](https://github.com/neryapy/seaterPlaner/releases/) section. No Python installation is required for the EXE version.
